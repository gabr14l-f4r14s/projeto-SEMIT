...
<head>
    ...
    <title>Editar Pizza | Bella Pizza Manager</title>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="?acao=create" class="sidebar-link">
                    <img src="public/img/icon_add_brown.svg" alt="Nova Pizza" class="sidebar-menu-icon">
                    Criar nova pizza
                </a>
        ...
        <main class="main-content">
            ...
            <section class="page-header">
                ...
                <p class="page-description">
                    Atualize as informações da pizza e seus ingredientes.
                </p>
                ...
                <form action="?acao=update" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            name="nome"
                            class="form-control"
                            value="<?= htmlspecialchars($pizza['nome']); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            inputmode="decimal"
                            class="form-control"
                            value="<?= number_format($pizza['preco'], 2, ',', ''); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <label class="form-label ingredients-label">Ingredientes:</label>
                        ...
                        <?php foreach ($ingredientes as $ingrediente): ?>
                            ...
                            <div class="form-check">
                                ...
                                <input
                                    ...
                                    <?= in_array($ingrediente['id'], $ingredientesDaPizza) ? 'checked' : ''; ?>>
